...
@section('content')
    ...
    <table class="w-full text-left transition-opacity ease-in-out duration-100">
        ...
        <tr class="text-black">
            ...
            <th class="font-normal px-3 pt-0 pb-3 border-b border-gray-200 dark:border-gray-800">Model</th>
            <th class="font-normal px-3 pt-0 pb-3 border-b border-gray-200 dark:border-gray-800">Placowka</th>
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="space-y-6">
                            <form id="editForm" action="{{ route('hulajnogi.update', $hulajnoga->id) }}" method="POST">
                                ...
                                @method('PUT')
                                <div class="p-6">
                                    <label for="edit_nazwa{{$hulajnoga->id}}" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nazwa</label>
                                    <input type="text" id="edit_nazwa{{$hulajnoga->id}}" value="{{$hulajnoga->Nazwa}}" name="nazwa" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                                </div>
                                <div class="pb-6 ps-6 pe-6">
                                    <label for="edit_adres{{$hulajnoga->id}}" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Adres</label>
                                    <input type="text" id="edit_adres{{$hulajnoga->id}}" value="{{$hulajnoga->Model}}" name="adres" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                                </div>
                                <div class="p-6">
                                    <label for="placowka" class="block mb-2 text-sm font-medium text-gray-900 dark:text-whit">Przypisz do placówki</label>

                                    <select name="placowka_id" id="edit_placowka{{$hulajnoga->id}}" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="space-y-6">
                    <form id="addForm" action="{{ route('hulajnogi.store') }}" method="POST">
                        ...
                        <div class="pb-6 ps-6 pe-6">
                            <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Model</label>
                            <input type="text"  name="model" id="model"class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                        </div>
                        <div class="p-6">

                        <label for="placowka" class="block mb-2 text-sm font-medium text-gray-900 dark:text-whit">Przypisz do placówki</label>
                        <select name="placowka_id" id="placowka" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                            @foreach($placowki ?? [] as $placowka)

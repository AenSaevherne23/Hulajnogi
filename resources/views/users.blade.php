...
<div id="defaultModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 flex items-center justify-center hidden w-full h-screen bg-opacity-50 bg-gray-900">
    ...
    <input type="text" class="form-control w-full border-gray-300 rounded-lg focus:ring-blue-300" id="name" name="name" value="{{ $client->name }}" required>
</div>

<div class="mb-4">
    <label for="email" class="block text-gray-800 dark:text-white font-semibold mb-1">Email</label>
    <input type="email" class="form-control w-full border-gray-300 rounded-lg focus:ring-blue-300" id="email" name="email" value="{{ $client->email }}" required>
</div>

...
<div class="mt-6 flex justify-end">
    ...
    <!-- Main modal -->
<!-- Main modal -->
<div id="registrationModal" tabindex="-1" aria-hidden="true" class="modal fixed inset-0 flex items-center justify-center z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-gray-500 opacity-75"></div>
    ...
    <div class="modal-container bg-white w-full mx-auto rounded shadow-lg z-50 max-w-md">
        <div class="modal-content py-4 text-left px-6">
            <!-- Modal header -->
            <div class="flex justify-between items-center pb-3">
                <h2 class="text-xl font-bold">Dodaj pracownika</h2>
                <button class="modal-close cursor-pointer z-50">
                    <svg class="fill-current text-gray-700" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                        <path d="M0 1.01L1.01 0 9 7.99 16.99 0 18 1.01 10.01 9l7.99 7.99L16.99 18 9 10.01 1.01 18 0 16.99 7.99 9 0 1.01z"></path>
                    </svg>
                </button>
            </div>
            ...
            <div class="my-4">
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="name" class="block text-gray-800 dark:text-white font-semibold mb-1">Imię i nazwisko</label>
                        <input type="text" class="form-input w-full border-gray-300 rounded-lg focus:ring-blue-300" id="name" name="name" value="{{ old('name') }}" required autofocus>
                        @error('name')
                    ...
                    <div class="mb-4">
                        <label for="email" class="block text-gray-800 dark:text-white font-semibold mb-1">Email</label>
                        <input type="email" class="form-input w-full border-gray-300 rounded-lg focus:ring-blue-300" id="email" name="email" value="{{ old('email') }}" required>
                        @error('email')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="password" class="block text-gray-800 dark:text-white font-semibold mb-1">Hasło</label>
                        <input type="password" class="form-input w-full border-gray-300 rounded-lg focus:ring-blue-300" id="password" name="password" required>
                        @error('password')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="salary" class="block text-gray-800 dark:text-white font-semibold mb-1">Wynagrodzenie</label>
                        <input type="text" class="form-input w-full border-gray-300 rounded-lg focus:ring-blue-300" id="salary" name="salary" value="{{ old('salary') }}" required>
                        @error('salary')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>

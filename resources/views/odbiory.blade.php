              ...
              <div class="space-y-6">
                  <form id="addForm" action="{{ route('odbiory.store') }}" method="POST">
                      ...
                      <div class="pb-6 ps-6 pe-6">
                          <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wypożyczenie:
                      ...
                      <div class="pb-6 ps-6 pe-6">
                          <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dodaj rewizje (opcjonalnie):</label>
